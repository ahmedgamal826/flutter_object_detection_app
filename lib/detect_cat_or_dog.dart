...
class DetectCatOrDog extends StatefulWidget {
  const DetectCatOrDog({super.key});

  @override
  _ObjectDetectionScreenState createState() => _ObjectDetectionScreenState();
}

class _ObjectDetectionScreenState extends State<DetectCatOrDog> {
  ...
  loadmodel() async {
    await Tflite.loadModel(
      model: "assets/cat_or_dog.tflite",
      labels: "assets/catOrDogsLabel.txt",
    );
  }

  // Load labels from labels.txt file
  loadLabels() async {
    final labels = await rootBundle.loadString('assets/catOrDogsLabel.txt');
    setState(() {
      knownLabels =
